  ...
  return (
    <div className="text-center">
      <div>
        {posts.map((post) => (
          <div className="post-container w-[90%] md:w-[75%] mx-auto my-4 px-4 border rounded-lg shadow-md" key={post.id}>
            ...
            <div className='mt-2 lg:ml-[100px] md:mt-4 pb-4 text-left font-semibold flex items-center'>
      ...
      {isModalOpen && selectedPost && (
        <div className="flex fixed top-0 justify-center h-screen w-full backdrop-blur-sm cursor-pointer" onClick={() => closeModal()}>
          <div className="post-container w-full md:w-[85%] m-auto max-h-[55%] overflow-y-scroll px-4 bg-white border rounded-lg shadow-md" key={selectedPost.id}>
            <div>
              <div className='flex items-center'>
                <div className="relative w-[75px] h-[75px] rounded-full overflow-hidden mt-4 border-slate-500 border-[1px]">
                  <Image
              ...
              <p className='mt-2 md:mt-4 text-left'>{selectedPost.content}</p>
              <PostIcons />
            ...
            <div className='mt-2 md:mt-4 pb-4 text-left font-semibold flex items-center'>
